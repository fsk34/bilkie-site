...
export default function KayitSayfasi() {
  ...
  function geri() {
    ...
    else router.push("/uygulama/giris");
  }
  ...
  async function googleIleDevam() {
    ...
    try {
      ...
      router.replace(`/uygulama/kayit/google${yeniMi ? "" : "?devam=1"}`);
    } catch (err) {
    ...
    <div className="bk bk-kayit">
      <div className="bk-kayit-cerceve">
          ...
          >
            ...
            {epostaDolu && (
              <p className="bk-hata">
                ...
                <Link href="/uygulama/giris">Giriş yap</Link> ya da başka bir adres dene.
              </p>
            )}
            <OnaySatiri
              isaretli={sartlar}
        ...
        <p className="bk-soluk bk-kayit-alt">
          Hesabın var mı? <Link href="/uygulama/giris">Giriş yap</Link>
        </p>
      </div>
    </div>
  );
