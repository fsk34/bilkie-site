  ...
  return (
    <div className="bk-ayarlar">
      <div className="bk-ayarlar-ust">
        ...
        <h1>Ayarlar</h1>
        <Link className="bitti" href="/uygulama">Bitti</Link>
      </div>

      <h2>Hesap</h2>
      <div className="bk-ayarlar-kart">
        <Link className="satir" href="/uygulama/profil/duzenle">
          <span>Hesap</span><i>›</i>
        </Link>
      ...
      {kullanici ? (
        ...
        <Link className="bk-ayarlar-dugme" href="/uygulama/giris">GİRİŞ YAP</Link>
      )}
