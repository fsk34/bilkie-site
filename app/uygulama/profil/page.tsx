    ...
    <>
      ...
      <div style={{ marginBottom: 18 }}>
        <div className="bk-kart-ust">
          <h3>Başarılar</h3>
          <Link href="/uygulama/basarimlar">TÜMÜNÜ GÖSTER</Link>
        </div>
      ...
      <div style={{ marginBottom: 18 }}>
        <div className="bk-kart-ust">
          <h3>Rozetler</h3>
          <Link href="/uygulama/rozetler">TÜMÜNÜ GÖSTER</Link>
        </div>
        <div className="bk-kart">
      ...
      <div className="bk-kart">
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <Link className="bk-dugme" href="/uygulama/profil/duzenle">Hesap</Link>
          <button className="bk-dugme kirmizi" onClick={() => cikisYap()}>Çıkış yap</button>
          <Link className="bk-dugme acik" href="/uygulama/seri">Serini gör</Link>
        </div>
      </div>
