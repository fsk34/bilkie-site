...
const BUYUKLER = [
  { baslik: "KONU TESTLERİ",    alt: "Testleri çöz ve kusursuz ol",        gorsel: "test",   yol: "/testler" },
  { baslik: "KONU DEFTERLERİ",  alt: "Defterleri oku, konuları pekiştir",  gorsel: "defter", yol: "/defterler" },
  { baslik: "YAZILIYA HAZIRLIK", alt: "Yazılılara en iyi şekilde hazırlan", gorsel: "yazili", yol: "/yazili" },
];
